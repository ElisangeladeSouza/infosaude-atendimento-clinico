...
public class CadastroEnfermeiroObrigatorioCompleto {
  ...
  @Test
  public void testCadastroEnfermeiroObrigatorioCompleto() throws Exception {
    ...
    driver.findElement(By.id("tabEnfermeiro:formCadastroEnfermeiro:nome")).sendKeys("Luis Ganso");
