...
public class CadastroEnfermeiroSemNome {
  ...
  @Test
  public void testCadastroEnfermeiroSemNome() throws Exception {
    ...
    try {
      assertEquals("É preciso digitar um nome", driver.findElement(By.cssSelector("span.ui-growl-title")).getText());
    } catch (Error e) {
