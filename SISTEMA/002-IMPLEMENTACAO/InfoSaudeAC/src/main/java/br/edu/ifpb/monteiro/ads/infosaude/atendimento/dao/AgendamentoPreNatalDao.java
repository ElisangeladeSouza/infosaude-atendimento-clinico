 ...
 */
public class AgendamentoPreNatalDao extends DaoAbstrato<AgendamentoPreNatal>implements Serializable {
    
    private static final long serialVersionUID = 1L;

    public AgendamentoPreNatalDao() {
        super(AgendamentoPreNatal.class);
    }
}
