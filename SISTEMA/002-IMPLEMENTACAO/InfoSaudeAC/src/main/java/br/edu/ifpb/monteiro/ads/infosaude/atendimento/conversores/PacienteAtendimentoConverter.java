 ...
 * @author elisangela
 */
@FacesConverter(value = "pacienteAtendimentoConverter")
public class PacienteAtendimentoConverter implements Converter {

    private final FichaAtendimentoService fichaAtendimentoService;

    public PacienteAtendimentoConverter() throws UBSException {
