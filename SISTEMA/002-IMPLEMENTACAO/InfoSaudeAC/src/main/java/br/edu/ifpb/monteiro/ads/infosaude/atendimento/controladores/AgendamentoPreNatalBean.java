...
/**
 * Managed bean usado pela página de cadastro de Agendamento de pré-natal. 
 * É responsável por ligar a classe de modelo AgendamentoPreNatal à página de visualização 
...
public class AgendamentoPreNatalBean implements Serializable {
    ...
    */
     ...
     * AgendamentoPreNatal e salvar. Se algum erro ocorrer, deve-se fazer rollback e 
    ...
    public void salvar() throws NegocioException {
     ...
     /**
     * Método responsável por excluir um objeto do tipo AgendamentoPreNatal e exibir
